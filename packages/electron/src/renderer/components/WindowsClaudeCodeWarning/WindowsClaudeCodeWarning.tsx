...
export const WindowsClaudeCodeWarning: React.FC<WindowsClaudeCodeWarningProps> = ({
  ...
  return (
    <div
      className="windows-warning-overlay nim-overlay bg-black/60"
    ...
    >
      ...
      >
        ...
        <div className="windows-warning-content px-8 pt-12 pb-8 text-center">
          ...
          <div
            className="windows-warning-footer pt-4 flex items-center justify-center gap-2 border-t border-nim"
          >
            <button
