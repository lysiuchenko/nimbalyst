  ...
  return (
    <div className="api-service-error-widget my-3 p-3 rounded-lg flex flex-col gap-2">
      ...
      <div className="text-[var(--nim-text-muted)] text-[0.85rem] leading-relaxed">
        {isOverloaded
          ? 'This is an upstream capacity error on the API side, not a bug in Glue. The API will accept new requests once load eases. Retrying in a minute usually works; switching to a less-loaded model also helps.'
          : 'This is a transient upstream error on the API side, not a bug in Glue. Most cases clear within a few minutes.'}
      </div>
